...
from core.script.Events.person_identification_event import PersonIdentificationEvent
...
class Events:
    def __init__(self, camera_id: int,
        ...
        self.person_identification_event = PersonIdentificationEvent(
            self.camera_id,
            self.camera_group_id
        )
    ...
    def call(self, img_obj_data: dict, img_size: tuple[Any, Any]) -> None:
        ...
        self.person_identification_event.call(img_obj_data, img_size)
        pass
